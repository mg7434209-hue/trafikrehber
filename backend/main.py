...
# create_all yalnız YENİ TABLO oluşturur, var olan tabloya kolon EKLEMEZ.
# Migration aracı olmadığı için sonradan eklenen kolonlar burada güvenle
# (IF NOT EXISTS) açılır. Yeni kolon eklerken bu listeye bir satır ekle.
def _eksik_kolonlari_ekle():
    from sqlalchemy import text
    kolonlar = [
        ("ceza_turleri", "kademe_notu", "TEXT"),
    ]
    with engine.begin() as conn:
        for tablo, kolon, tip in kolonlar:
            try:
                conn.execute(text(f'ALTER TABLE {tablo} ADD COLUMN IF NOT EXISTS {kolon} {tip}'))
            except Exception as e:  # tablo henüz yoksa sorun değil
                print(f"[migrate] {tablo}.{kolon} atlandı: {e}")
...
def run_seed():
    ...
    for a in [
        {"slug":"trafik-cezasi-itiraz-nasil-yapilir","title":"Trafik Cezasına İtiraz Nasıl Yapılır? (2026)","meta_description":"Trafik cezasına itiraz adım adım rehber.","content":"<h2>İtiraz Hakkınız</h2><p>Tebliğden itibaren <strong>15 gün içinde</strong> Sulh Ceza Hâkimliği'ne itiraz edebilirsiniz.</p>","category":"ceza","tags":["itiraz","trafik cezası"],"is_published":True,"is_featured":True,"reading_time_min":5,"schema_type":"HowTo"},
...
def run_rich_seed():
    ...
    articles_data = [
        {"slug":"trafik-cezasi-itiraz-nasil-yapilir","title":"Trafik Cezasına İtiraz Nasıl Yapılır? (2026 Güncel Rehber)","meta_description":"Trafik cezasına itiraz nasıl yapılır? 15 günlük itiraz süresi, Sulh Ceza Hâkimliği başvurusu ve hazır dilekçe örneği (2026).","category":"ceza","tags":["itiraz","trafik cezası","sulh ceza"],"reading_time_min":8,"schema_type":"HowTo","is_published":True,"is_featured":True,"content":"<h2>Trafik Cezasına İtiraz Hakkınız</h2><p>Tebliğden itibaren <strong>15 gün içinde</strong> Sulh Ceza Hâkimliği'ne itiraz edebilirsiniz. Bu süreyi <strong>ödeme indirimi süresiyle karıştırmayın</strong>: cezayı indirimli ödemek için 1 ay (30 gün) süreniz vardır.</p><h2>İtiraz Adımları</h2><ol><li>Tutanağı inceleyin</li><li>Gerekçenizi belirleyin</li><li>Dilekçe hazırlayın</li><li>Sulh Ceza Hâkimliği'ne başvurun</li></ol><div style='background:#fff8e6;border-left:4px solid #f59e0b;padding:16px 20px;margin:24px 0;border-radius:0 8px 8px 0'>⚖️ Genel bilgilendirme amaçlıdır.</div>"},
        {"slug":"trafik-cezasi-tutarlari-2025","title":"2026 Trafik Cezası Tutarları — Güncel Tam Liste","meta_description":"2026 güncel trafik cezası tutarları: kırmızı ışık, hız, alkol, cep telefonu. 7574 sayılı Kanun ile kademeli cezalar.","category":"ceza","tags":["ceza tutarları","2026","7574 sayılı kanun"],"reading_time_min":6,"schema_type":"Article","is_published":True,"is_featured":True,"content":"<h2>2026 Trafik Cezası Tutarları</h2><p>27 Şubat 2026 tarihli <strong>7574 sayılı Kanun</strong> ile kırmızı ışık, cep telefonu, alkol ve hız cezaları <strong>kademeli</strong> hâle geldi: aynı ihlali tekrarlayanın cezası katlanıyor.</p><p>Tebliğden itibaren <strong>1 ay (30 gün) içinde ödemede %25 indirim</strong> uygulanır. <strong>İtiraz süresi ayrıdır ve 15 gündür.</strong></p><table border='1' style='border-collapse:collapse;width:100%'><tr style='background:#1e3a5f;color:white'><th style='padding:8px'>İhlal</th><th>Taban Ceza</th><th>%25 İndirimli</th></tr><tr><td style='padding:8px'>Kırmızı ışık (ilk ihlal)</td><td>5.000 TL</td><td>3.750 TL</td></tr><tr style='background:#f9f9f9'><td style='padding:8px'>Cep telefonu (ilk ihlal)</td><td>5.000 TL</td><td>3.750 TL</td></tr><tr><td style='padding:8px'>Alkollü araç kullanma (1. kez)</td><td>25.000 TL</td><td>18.750 TL</td></tr><tr style='background:#f9f9f9'><td style='padding:8px'>Emniyet kemeri</td><td>1.246 TL</td><td>934,50 TL</td></tr></table><p>Hız cezalarında yüzde bazlı kademeler kaldırıldı; ceza aşılan <strong>km/saate</strong> göre 2.000 TL ile 30.000 TL arasında uygulanır. Tam liste için <a href='/trafik-cezalari-2026'>2026 ceza listesi</a> sayfasına bakın.</p><div style='background:#fff8e6;border-left:4px solid #f59e0b;padding:16px 20px;margin:24px 0;border-radius:0 8px 8px 0'>⚖️ Genel bilgilendirme amaçlıdır; kesin tutar için e-Devlet'teki ceza kaydınızı esas alın.</div>"},
